...
pub(super) struct Epoll {
    ...
    pub(super) fn new(max_events: usize, timeout_ms: i32) -> io::Result<Self> {
    ...
    pub(super) fn add_listener(&self, listener: &TcpListener) -> io::Result<()> {
    ...
    pub(super) fn add_stream(&self, stream: &TcpStream) -> io::Result<()> {
    ...
    pub(super) fn modify_stream(&self, stream: &TcpStream, readable: bool, writable: bool) -> io::Result<()> {
        let fd = stream.as_raw_fd();
    ...
    pub(super) fn remove_fd(&self, fd: i32) -> io::Result<()> {
    ...
    pub(super) fn wait(&mut self) -> io::Result<Vec<(i32, Event)>> {
