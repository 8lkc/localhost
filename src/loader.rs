use crate::{mux::Multiplexer, server::Server};
...
impl Loader {
    ...
    /// 4. Creating a new `Multiplexer` instance based on the parsed configuration.
    /// 
    /// # Arguments
    /// 
    ...
    /// # Returns
    /// 
    /// * `Ok(Multiplexer)`: Returns a initialized `Multiplexer` instance on success.
